  ...
  return (
    ...
    >
      <div className="flex h-full w-72 flex-col">
        <div className="border-b border-slate-200 p-3 dark:border-slate-800">
          <div className="mb-2 flex items-center gap-2">
            <Button
              ...
              title={collapsed ? 'Развернуть панель задач' : 'Свернуть панель'}
              aria-label={collapsed ? 'Развернуть панель задач' : 'Свернуть панель'}
            ...
            <div
              className={cn(
                'text-xs font-semibold uppercase tracking-wide text-slate-500 transition-opacity duration-200 dark:text-slate-400',
          ...
          <div className={cn('flex flex-col gap-1.5', fadeClass)}>
        ...
        <div className={cn('scrollbar-thin flex-1 space-y-1 overflow-y-auto p-2', fadeClass)}>
          {templates.length === 0 && (
        ...
        <div
          className={cn(
            'flex items-center gap-1.5 border-t border-slate-200 p-2 dark:border-slate-800',
            fadeClass,
          )}
        >
